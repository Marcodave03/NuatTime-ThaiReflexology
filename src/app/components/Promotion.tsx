  ...
  return (
    <section id="promotion-section" className="my-24 relative">
      ...
      <div className="hidden lg:block relative">
        ...
        {/* Content Container */}
        <div className="relative z-20 container mx-auto flex justify-end items-center h-screen">
          <div className="w-1/2 bg-white/70 backdrop-blur-md p-10 rounded-xl shadow-lg">
            ...
            <p className="text-xl font-serif mb-5" data-aos="fade-left">
              ...
              and soul. Don&atpos; miss this limited-time offer to enrich your
